      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md items-center justify-center p-4">
        <div className="w-full rounded-[32px] bg-slate-900 p-5 shadow-2xl">
          ...
          <div className="mt-6 grid grid-cols-4 gap-3">
            <button onClick={() => addValue(1)} className="btn border border-white/10">1</button>
            <button onClick={() => addValue(2)} className="btn border border-white/10">2</button>
            <button onClick={() => addValue(5)} className="btn border border-white/10">5</button>
            <button onClick={() => addValue(0.5)} className="btn-small border border-white/10">0.50</button>

            <button onClick={() => addValue(10)} className="btn border border-white/10">10</button>
            <button onClick={() => addValue(20)} className="btn border border-white/10">20</button>
